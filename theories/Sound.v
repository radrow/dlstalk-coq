...
Module Type SOUND_F(Import Conf : DETECT_CONF)(Import Params : DETECT_PARAMS(Conf)).
  ...
  Section Inversions.
    ...
    Lemma SRPC_M_net_in_net_Q_in_M [N : MNet] [ n c v v' MQ0 MQ1 M I P O] :
      net_sane N ->
    ...
    Proof.
      ...
      remember (&I ++ MQ_r MQ0) as I0 eqn:x.
      destruct (Deq_dec' I0 (c, Q)); hsimpl in *.
      - rename Q' into I0'.
        assert (Deq (c, Q) v0 ((&I ++ MQ_r MQ0) ++ (c, Q, v) :: I1) (I0' ++ (c, Q, v) :: I1)) by attac.
        bs (~ List.In (c, Q, v) (I0' ++ (c, Q, v) :: I1)) by attac.
      - assert (Deq (c, Q) v ((c, Q, v) :: I1) I1) by attac.
        bs (Deq (c, Q) v (_ ++ (c, Q, v) :: I1) (_ ++ I1)) by eauto using Deq_app_l_not_Deq.
    Qed.

    Lemma SRPC_M_net_in_net_Q_in_M0 [N : MNet] [ n c v v' MQ0 MQ1 M S] :
      net_sane N ->
    ...
    Lemma SRPC_M_net_in_net_Q_in_M1 [N : MNet] [ n c v v' MQ0 MQ1 M S] :
      net_sane N ->
      NetMod.get n N = mserv (MQ0 ++ TrRecv (c, Q) v :: MQ1) M S ->
    ...
    Lemma SRPC_M_net_in_net_Q_in_MP [N : MNet] [ n c v v' MQ0 MQ1 M I P O] :
      net_sane N ->
      NetMod.get n N = mserv (MQ0 ++ TrRecv (c, Q) v :: MQ1) M (serv I P O) ->
      ~ List.In (c, Q, v') I.
    Proof. intros.
    ...
    Lemma SRPC_M_net_in_net_Q_in_P [N : MNet] [ n c v v' MQ M I I' P O] :
      net_sane N ->
    ...
    Lemma SRPC_M_net_in_net_Q_in_PP [N : MNet] [ n c v v' MQ M I I' P O] :
      net_sane N ->
      NetMod.get n N = mserv MQ M (serv I P O) ->
      Deq (c, Q) v I I' ->
      ~ List.In (c, Q, v') I'.
    Proof. intros.
           ...
           iattac.
    Qed.
    Lemma SRPC_M_net_in_net_Q_in_PM [N : MNet] [ n c v v' MQ M I I' P O] :
      net_sane N ->
      NetMod.get n N = mserv MQ M (serv I P O) ->
      Deq (c, Q) v I I' ->
    ...
    Lemma SRPC_M_net_in_net_R_in_M [N : MNet] [ n s s' v v' MQ0 MQ1 M I P O] :
      net_sane N ->
    ...
    Lemma SRPC_M_net_in_net_R_in_M0 [N : MNet] [ n s s' v v' MQ0 MQ1 M S] :
      net_sane N ->
    ...
    Proof.
      ...
      attac.
    Qed.
    Lemma SRPC_M_net_in_net_R_in_M1 [N : MNet] [ n s s' v v' MQ0 MQ1 M S] :
      net_sane N ->
      NetMod.get n N = mserv (MQ0 ++ TrRecv (s, R) v :: MQ1) M S ->
    ...
    Proof.
      ...
      attac.
    Qed.
    Lemma SRPC_M_net_in_net_R_in_MP [N : MNet] [ n s s' v v' MQ0 MQ1 M I P O] :
      net_sane N ->
      NetMod.get n N = mserv (MQ0 ++ TrRecv (s, R) v :: MQ1) M (serv I P O) ->
      ~ List.In (s', R, v') I.
    Proof.
    ...
    Lemma SRPC_M_net_in_net_R_in_lock [N : MNet] [ n s v MQ M S] :
      net_sane N ->
  ...
  Definition sends_to (N : MNet) n0 n1 p := sends_to_mon (mserv_m (N n0)) n1 p.
  ...
  Lemma sends_to_dec (MN0 : MNet) n0 n1 p : (sends_to MN0 n0 n1 p \/ ~ sends_to MN0 n0 n1 p).
  ...
  Inductive KIS (MN : MNet) :=
    KIS_
      ...
      (H_wait_S : forall n0 n1, List.In n0 (wait (MN n1)) -> net_lock_on MN n0 n1)
      ...
      (H_sendp_hot_S : forall n0 n1 n2, sends_to MN n1 n0 (hot_of n2) -> lock (MN n2) <> None -> dep_on MN n0 n2)
      (* If we received a hot probe of someone whose monitor considers locked, then we depend on them. *)
      (H_recvp_hot_S : forall n0 n1 n2, List.In (hot_ev_of n2 n0) (mserv_i (MN n1)) -> lock (MN n0) <> None -> dep_on MN n1 n0)
  ...
  Lemma KIS_wait [MN] : KIS MN -> forall n0 n1, List.In n0 (wait (MN n1)) -> net_lock_on MN n0 n1.
  Proof. intros; consider (KIS _). Qed.

  Lemma KIS_sendp [MN] : KIS MN -> forall n0 n1 p, sends_to MN n1 n0 p -> net_lock_on MN n0 n1.
  Proof. intros; consider (KIS _). eauto. Qed.

  Lemma KIS_sendp_hot [MN] : KIS MN -> forall n0 n1 n2, sends_to MN n1 n0 (hot_of n2) -> lock (MN n2) <> None -> dep_on MN n0 n2.
  Proof. intros; consider (KIS _). eauto. Qed.

  Lemma KIS_recvp_hot [MN] : KIS MN -> forall n0 n1 n2, List.In (hot_ev_of n2 n0 ) (mserv_i (MN n1)) -> lock (MN n0) <> None -> dep_on MN n1 n0.
  Proof. intros; consider (KIS _). eauto. Qed.
  ...
  Lemma KIS_sendp_hot_get [MN n0 n1 n2 p] [MQ1 MQ2 s1 s2 S1 S2] :
    KIS MN ->
  ...
  Proof. intros.
         destruct p.
         assert (sends_to MN n1 n0 (hot_of n2)) by (unfold hot_of in *; ltac1:(autounfold with LTS_get in * ); attac).
         assert (lock (MN n2) <> None) by (ltac1:(autounfold with LTS_get in * ); attac).
         eauto with LTS.
  Qed.


  Lemma KIS_recvp_hot_get [MN n0 n1 n2 p] [MQ0 MQ2 s0 s2 S0 S2] :
    KIS MN ->
  ...
  Proof. intros.
         destruct p.
         assert (List.In (hot_ev_of n1 n2 ) (mserv_i (MN n0))) by (unfold hot_ev_of, hot_of in *; ltac1:(autounfold with LTS_get in * ); attac).
         assert (lock (MN n2) <> None) by (ltac1:(autounfold with LTS_get in * ); attac).
         eauto with LTS.
  Qed.
  ...
  Notation "'' N" := (net_deinstr N) (at level 20).
  ...
  Hint Rewrite -> next_state_Send_all : LTS.
  ...
  Proof.
    ...
    - enough (forall n, lock (MN0 n0) <> Some n) by (destruct (lock (MN0 n0)); attac). intros ? ?.
      ...
      + hsimpl in *.
        ...
        assert (List.In (n, R, v0) I0).
        {
          ...
          unfold NetGet, net_deinstr, deinstr in *. hsimpl in *.
          attac.
        }
    ...
    - consider (_ =(_)=> _).
      compat_hsimpl in *.
      unfold NetGet, net_deinstr, deinstr in *.
      hsimpl in *.
      destruct s.
      simpl in *.
  ...
  Lemma M_alarm_set [MN0 MN1 a n0] :
    ...
    alarm (MN1 n0) = true ->
    a = NTau n0 (MActM Tau) /\
      exists n1, List.In (EvRecv (n1, R) {|init:=n0|}) (mserv_i (MN0 n0)).
  ...
  Lemma KIS_invariant_wait [MN0 MN1 a] :
    (MN0 =(a)=> MN1) ->
    KIS MN0 ->
    forall n0 n1, List.In n0 (wait (MN1 n1)) -> net_lock_on MN1 n0 n1.
  ...
  Proof.
    ...
    - assert ((exists v, a = NTau n1 (MActP (Recv (n0, Q) v))) \/ a = NTau n1 (MActM Tau)) as [|]
      ...
      + enough (List.In n0 (wait (MN1 n1))) by eauto using KIS_invariant_wait.
        ...
        par: unfold NetGet, sends_to in *; ltac1:(autounfold with LTS_get in * ); compat_hsimpl in *; try (rewrite next_state_Send_all); bs.
  Qed.
  ...
  Lemma dep_dec_after_M : forall (MN0 MN1 : MNet) ma n0 n1,
      net_sane MN0 ->
      dep_on MN0 n0 n1 ->
      (MN0 =(ma)=> MN1) ->
  ...
  Lemma KIS_invariant_recvp_hot [MN0 MN1 a] :
    (MN0 =(a)=> MN1) ->
    KIS MN0 ->
    forall n0 n1 n2, List.In (hot_ev_of n1 n2 ) (mserv_i (MN1 n0)) ->
                                  lock (MN1 n2) <> None ->
                                  dep_on MN1 n0 n2.
  ...
  Proof.
    ...
    assert (In (hot_ev_of n1 n2 ) (mserv_i (MN0 n0)) \/ ~ In (hot_ev_of n1 n2 ) (mserv_i (MN0 n0))) as [|].
    {
      ...
      destruct a; attac.
      destruct n.
      destruct (MProbe_eq_dec (hot_of n2) m); attac.
      destruct t; attac.
      smash_eq n n1; attac.
    }
    2: {
      unfold hot_ev_of in *.
      consider (a = NComm n1 n0 R ^ (hot_of n2)) by eauto using M_recv_ev_act.
      assert (sends_to MN0 n1 n0 (hot_of n2)).
      {
        remember (hot_of n2) as p; clear - H.
        consider (_ =(_)=> _); compat_hsimpl in *.
      ...
      consider (net_lock_on MN0 n0 n1 /\ net_lock_on MN1 n0 n1).
      {
        ...
        split; auto.
        destruct (net_sane_lock_dec MN1 n0 n1); eauto with LTS.
        consider (exists v, NComm n1 n0 R ^ (hot_of n2) = NComm n1 n0 R (MValP v)) by eauto using SRPC_M_net_unlock_reply with LTS.
        bs.
      }
      assert (lock (MN0 n2) <> None).
      {
        ...
        consider (exists v, NComm n1 n0 R ^ (hot_of n2) = NComm n2 n3 Q (MValP v)) by eauto using M_lock_set.
      }
    ...
    - 
      ...
      unfold NetGet in *.
      eattac.
      enough (dep_on MN0 n0 n2).
      {
        unshelve eapply net_deinstr_act_do in H; attac.
        eauto 2 using net_dep_Q_preserve with LTS.
      }
      consider (KIS _).
      eapply H_recvp_hot_S.
      unfold NetGet in *.
      rewrite `(NetMod.get n0 MN0 = _).
      attac.
      eauto with LTS.
      enough (dep_on MN0 n1 n2).
      {
        smash_eq n0 n1.
        enough (net_lock_on MN0 n0 n1) by eauto with LTS.
    ...
    - assert (lock_id (MN0 n2) = lock_id (MN1 n2)).
      ...
      replace (hot_ev_of n1 n2 ) with (hot_ev_of n1 n2 ) by (unfold hot_ev_of, hot_of; attac).
  ...
  Lemma KIS_invariant_sendp_hot [MN0 MN1 a] :
    (MN0 =(a)=> MN1) ->
    KIS MN0 ->
    (forall n0 n1 n2, sends_to MN1 n1 n0 (hot_of n2) -> lock (MN1 n2) <> None -> dep_on MN1 n0 n2).
  ...
  Proof.
    ...
    destruct (sends_to_dec MN0 n1 n0 (hot_of n2)) as [|].
    2: {
      ...
      - assert (dep_on MN0 n0 n2).
        {
          ...
          enough (exists n', List.In (hot_ev_of (n' n2)) (mserv_i (MN0 n1))) by (hsimpl in *; eauto with LTS).
    ...
    - assert (lock_id (MN0 n2) < lock_id (MN1 n2)).
      ...
      enough (index (hot_of n2) <= _of lock_id MN0 (init (hot_of n2))) by (simpl in *; lia).
      eauto with LTS.
    - assert (lock_id (MN0 n2) = lock_id (MN1 n2)).
      {
        destruct (PeanoNat.Nat.eq_dec (lock_id (MN0 n2)) (lock_id (MN1 n2))) as [He|He]; auto.
      ...
      replace (hot_of n2) with (hot_of n2) by (unfold hot_of; attac).
      assert (lock (MN0 n2) = Some n3).
      {
        destruct (lock (MN0 n2)) as [n3'|] eqn:?.
        - enough (n3 = n3') by attac.
  ...
  Proof.
    ...
    assert (List.In (hot_ev_of n1 n ) (mserv_i (MN0 n))) by eauto with LTS.
  ...
  Corollary detection_soundness_instr [N0 : PNet] [i0 : instr] [MN1 mpath0 n] :
    KIS (i0 N0) ->
    (i0 N0 =[ mpath0 ]=> MN1) ->
    alarm (MN1 n) = true ->
  ...
  Proof.
    ...
    consider (exists mpath1 path i2 N2, (MN1 =[ mpath1 ]=> i2 N2) /\ (N0 =[ path ]=> N2)) by eauto using Net_Transp_soundness.
